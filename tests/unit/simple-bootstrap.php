<?php
/**
 * Simple bootstrap file for tests that don't use Brain\Monkey
 * This file contains WordPress function mocks needed for basic testing.
 */
...
/**
 * Mock WordPress esc_html function for ChargeService namespace
 *
 * @param string $text Text to escape.
 * @return string Escaped text.
 */
